...
public class ReviewService {
    ...
    @Transactional
    public void addReview(AuthUser authUser , Long orderId , ReviewRequest.WriteReview writeReview , List<MultipartFile> files) {
        ...
        Review review = Review.builder()
                ...
                .content(writeReview.contents())
                .star(writeReview.star())
                .orders(orders)
                .build();
